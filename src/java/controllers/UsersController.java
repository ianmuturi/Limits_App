...
public class UsersController implements Serializable {
    ...
    @EJB
    private models.UsersFacade ejbFacade;
    ...
    public String prepareLogin() {
        System.out.println("-----------------"+ejbFacade.getUsersByName(current.getName())+"---"+current.getPassword());
        
        if(ejbFacade.getUsersByName(current.getName()).size()>0){
            if(ejbFacade.getUsersByPassword(current.getPassword()).size()>0){
              return "index.xhtml";  
            }else{
